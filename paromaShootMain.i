...
void goToStart() {
    ...
    drawBigChar(20, 74, 0, ((0) | (31)<<5 | (31)<<10));
    drawBigChar(20, 91, 1, ((0) | (31)<<5 | (31)<<10));
    drawBigChar(20, 108, 2, ((0) | (31)<<5 | (31)<<10));
    drawBigChar(20, 125, 3, ((0) | (31)<<5 | (31)<<10));
    drawBigChar(20, 142, 4, ((0) | (31)<<5 | (31)<<10));
    drawBigChar(20, 159, 1, ((0) | (31)<<5 | (31)<<10));
    drawString(60, 80, "START", ((31) | (31)<<5 | (0)<<10));
    drawString(80, 80, "INSTRUCTION", ((31) | (31)<<5 | (31)<<10));
    drawString(100, 80, "QUIT", ((31) | (31)<<5 | (31)<<10));
...
void start() {
    ...
    if ((!(~(oldButtons)&((1<<6))) && (~buttons & ((1<<6))))) {
     if (menuState == INSTRUCTION) {
      ...
      drawString (100, 80, "QUIT", ((31) | (31)<<5 | (31)<<10));
      drawString (80, 80, "INSTRUCTION", ((31) | (31)<<5 | (0)<<10));
     }
    }
    if ((!(~(oldButtons)&((1<<7))) && (~buttons & ((1<<7))))) {
     if (menuState == GAMESTART) {
      menuState = INSTRUCTION;
      drawString (60, 80, "START", ((31) | (31)<<5 | (31)<<10));
      drawString (80, 80, "INSTRUCTION", ((31) | (31)<<5 | (0)<<10));
     } else if (menuState == INSTRUCTION) {
      menuState = QUIT;
      drawString (80, 80, "INSTRUCTION", ((31) | (31)<<5 | (31)<<10));
      drawString (100, 80, "QUIT", ((31) | (31)<<5 | (0)<<10));
     }
    }
...
void goToInstruction() {
 ...
 drawString (10, 83, "INSTRUCTION", ((31) | (31)<<5 | (31)<<10));
 drawString (30, 44, "SHOOT FOR THE RED ENEMIES", ((31) | (31)<<5 | (31)<<10));
 drawString (40, 64, "AVOID BLUE PAROMAS", ((31) | (31)<<5 | (31)<<10));
 drawString (70, 60, "MOVE : <- and ->", ((31) | (31)<<5 | (31)<<10));
 drawString (80, 60, "SHOOT: X", ((31) | (31)<<5 | (31)<<10));
 drawString (90, 60, "PAUSE: ENTER", ((31) | (31)<<5 | (31)<<10));
 drawString (140, 15, "Hit BACKSPACE to go to main menu", ((31) | (31)<<5 | (31)<<10));
...
void goToGame() {
    ...
    drawString(145, 5, "Enemy Remaining:", 0);
...
void game() {
    ...
    drawRect(145, 107, 10, 6, ((31) | (31)<<5 | (31)<<10));
    drawString(145, 107, buffer, 0);
...
void goToPause() {
    ...
    drawString(30, 100, "Pasue", ((31) | (31)<<5 | (31)<<10));
    drawString(50, 80, "RETURN TO GAME", ((31) | (31)<<5 | (0)<<10));
    drawString(70, 80, "INSTRUCTION", ((31) | (31)<<5 | (31)<<10));
    drawString(90, 80, "MAIN MENU", ((31) | (31)<<5 | (31)<<10));
...
void pause() {
    ...
    if ((!(~(oldButtons)&((1<<6))) && (~buttons & ((1<<6))))) {
     if (menuState == INSTR) {
      ...
      menuState = INSTR;
      drawString (90, 80, "MAIN MENU", ((31) | (31)<<5 | (31)<<10));
      drawString (70, 80, "INSTRUCTION", ((31) | (31)<<5 | (0)<<10));
     }
    }
    if ((!(~(oldButtons)&((1<<7))) && (~buttons & ((1<<7))))) {
     if (menuState == GAMESTART) {
      menuState = INSTR;
      drawString (50, 80, "RETURN TO GAME", ((31) | (31)<<5 | (31)<<10));
      drawString (70, 80, "INSTRUCTION", ((31) | (31)<<5 | (0)<<10));
     } else if (menuState == INSTR) {
      menuState = QUIT;
      drawString (70, 80, "INSTRUCTION", ((31) | (31)<<5 | (31)<<10));
      drawString (90, 80, "MAIN MENU", ((31) | (31)<<5 | (0)<<10));
     }
    }
...
void goToWin() {
    ...
    drawString(70, 110, "WIN", ((31) | (31)<<5 | (31)<<10));
    drawString(90, 25, "Press ENTER Button to go to menu", ((31) | (31)<<5 | (31)<<10));
...
void goToLose() {
    ...
    drawString(70, 110, "LOSE", ((31) | (31)<<5 | (31)<<10));
    drawString(90, 25, "Press ENTER Button to go to menu", ((31) | (31)<<5 | (31)<<10));
